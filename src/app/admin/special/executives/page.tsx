...
export default function AdminSpecialExecutivesPage() {
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-amber-800">특우회 임원 관리</h1>
      ...
      {showForm && (
        <ExecutiveFormModal position={editing} onClose={() => { setShowForm(false); setEditing(null) }}
